...
export const metadata: Metadata = {
  title: "Treehouse — Cannabis Directory",
  description: "Discover and explore cannabis dispensaries.",
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={cn("bg-gray-100 font-sans antialiased dark:bg-black dark:text-white", GeistSans.variable)}>
